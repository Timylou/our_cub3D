...
#    Updated: 2025/11/10 18:30:46 by brturcio         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
BONUS_SRCS :=	main_bonus.c file_bonus.c parse_bonus.c error_bonus.c init_bonus.c header_bonus.c \
				...
				draw_texture_bonus.c proyection_bonus.c add_door_bonus.c error_two_bonus.c  \
				time_bonus.c minimap_bonus.c sprites_bonus.c sprites_utils_bonus.c sprites_draw_bonus.c \
				mouse_bonus.c
